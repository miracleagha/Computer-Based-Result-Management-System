...
import {
  HiOutlineBell, HiOutlineArrowRightOnRectangle, HiOutlineMagnifyingGlass,
  ...
  return (
    <header style={{
      ...
      <div style={{
        ...
        padding: '0.5rem 1rem', width: 300, boxShadow: '3px 3px 0px #000',
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '0.625rem' }}>
        <button style={{
          ...
          color: '#000', position: 'relative', boxShadow: '2px 2px 0px #000',
          transition: 'all 0.2s cubic-bezier(0.175, 0.885, 0.32, 1.275)',
        }}
        ...
        >
          ...
          <span style={{ position: 'absolute', top: 6, right: 6, width: 8, height: 8, borderRadius: '50%', background: '#dc2626', border: '2px solid #ffe17c' }} />
        </button>
        ...
        <div ref={dropdownRef} style={{ position: 'relative' }}>
          ...
          >
            <div style={{
              ...
              color: profileOpen ? '#000' : roleColor[user?.role] || '#fff',
            ...
            <div style={{ textAlign: 'left' }}>
              ...
              <div style={{ fontFamily: "'Satoshi', sans-serif", fontSize: '0.6875rem', fontWeight: 500, color: profileOpen ? '#b7c6c2' : '#666', textTransform: 'capitalize' }}>
                {user?.role}
              </div>
            </div>
          </button>
            ...
            {profileOpen && (
              ...
              >
                <div style={{ padding: '0.75rem 1rem', borderBottom: '1px solid rgba(0,0,0,0.1)' }}>
                  ...
                  <div style={{ fontFamily: "'Cabinet Grotesk', sans-serif", fontSize: '0.875rem', fontWeight: 800, color: '#000', marginTop: 2 }}>{user?.email}</div>
                </div>
                <button
